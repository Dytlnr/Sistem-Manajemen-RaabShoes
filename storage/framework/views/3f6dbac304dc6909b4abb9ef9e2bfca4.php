        ...
        <style>
            ...
            * {
            ...
            .left-panel::before {
                ...
                aspect-ratio: 1.23;
                background: url("<?php echo e(asset('images/auth-scooter-illustration.png')); ?>") center / contain no-repeat;
            ...
            .right-panel {
                background:
                    ...
                    url("<?php echo e(asset('images/login-shoe-cleaning-bg.png')); ?>") center / cover no-repeat,
        ...
        <div class="login-layout">
            ...
            <div class="card-wrap">
                <main class="login-card">
                    ...
                    <form class="form-block" action="<?php echo e(route('login.attempt')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="field is-primary">
                            <label for="email">Enter your username or email address</label>
                            <div class="input-shell">
                                <input id="email" name="email" type="text" value="<?php echo e(old('email')); ?>" placeholder="Username or email address">
                            </div>
                        </div>
                        ...
                        <div class="social-row">
                            <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="social-btn google">
...
<?php /**PATH /Users/user/Downloads/raabshoes/manajement-raabshoes/resources/views/auth/login.blade.php ENDPATH**/ ?>