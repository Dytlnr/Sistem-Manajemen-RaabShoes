...
<?php $__env->startSection('page-subtitle', 'Lihat dan telusuri riwayat transaksi Anda dengan mudah'); ?>
<?php $__env->startSection('active-menu', 'transaction-history'); ?>
...
<section class="filter-card">
    <form method="get" action="<?php echo e(route('transaction-history.index')); ?>" class="filter-form">
        <div class="filter-row">
            <div class="control"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"></circle><path d="M20 20l-3.5-3.5"></path></svg><input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari order ID atau nama....."></div>
            <details class="filter-dropdown">
                ...
                <div class="filter-menu">
                    <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('transaction-history.index', array_filter(['search' => $search, 'status' => $status, 'date_from' => $dateFrom, 'date_to' => $dateTo]))); ?>" class="filter-option <?php echo e($activeStatus === $status ? 'active' : ''); ?>"><?php echo e($status); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </details>
            <div class="control"><input type="date" name="date_from" value="<?php echo e($dateFrom); ?>"></div>
            <div class="control"><input type="date" name="date_to" value="<?php echo e($dateTo); ?>"></div>
            <div class="filter-actions">
                <button type="submit" class="filter-btn submit">Terapkan</button>
                <a href="<?php echo e(route('transaction-history.index')); ?>" class="filter-btn reset">Reset</a>
            </div>
        </div>
    ...
    <section class="history-list">
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <article class="history-card">
                <div>
                    <div class="history-code"><?php echo e($order['id']); ?></div>
                ...
                <div class="history-detail">
                    <div class="history-detail-row"><span class="history-detail-label">Barang:</span><span class="history-detail-value"><?php echo e($order['service_choice']); ?></span></div>
                    <div class="history-detail-row"><span class="history-detail-label">Layanan:</span><span class="history-detail-value"><?php echo e($order['service']); ?></span></div>
                    <div class="history-detail-row"><span class="history-detail-label">Metode Pembayaran:</span><span class="history-detail-value"><?php echo e($order['payment_method'] ?: '-'); ?></span></div>
                    <div><span class="status-badge"><?php echo e($order['status']); ?></span></div>
                </div>
            </article>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </section>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/user/Downloads/raabshoes/manajement-raabshoes/resources/views/transaction-history/index.blade.php ENDPATH**/ ?>