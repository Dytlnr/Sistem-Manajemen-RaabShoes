...
<?php if($submittedOrder): ?>
    ...
    <?php if($estimatedPickupAt && str_contains($estimateLabel, 'jam') && preg_match_all('/\d+/', $estimateLabel, $matches)): ?>
        <?php ($estimatedPickupAt = $estimatedPickupAt->copy()->addHours((int) end($matches[0]))); ?>
    <?php elseif($estimatedPickupAt && str_contains($estimateLabel, 'hari') && preg_match_all('/\d+/', $estimateLabel, $matches)): ?>
...
<?php endif; ?>
<a href="<?php echo e(route('orders.index')); ?>" class="back-link"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/><path d="M9 12h10"/></svg><span>Kembali ke Daftar Orderan</span></a>
<section class="form-panel">
    <?php if(session('success')): ?>
        <div class="flash-message">
            <strong><?php echo e(session('success')); ?></strong>
            <?php if(session('uploaded_photo_name')): ?>
                <span>File tersimpan: <?php echo e(session('uploaded_photo_name')); ?></span>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if($submittedOrder): ?>
        <div class="receipt-card">
            ...
            <div class="receipt-grid">
                <div class="receipt-item"><span class="receipt-label">Nama Pelanggan</span><span class="receipt-value"><?php echo e($submittedOrder['customer_name']); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Nomor HP</span><span class="receipt-value"><?php echo e($submittedOrder['phone']); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Barang</span><span class="receipt-value"><?php echo e($submittedOrder['service_choice']); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Layanan</span><span class="receipt-value"><?php echo e($submittedOrder['service']); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Warna</span><span class="receipt-value"><?php echo e($submittedOrder['color'] ?: '-'); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Merek</span><span class="receipt-value"><?php echo e($submittedOrder['brand'] ?: '-'); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Metode Pembayaran</span><span class="receipt-value"><?php echo e($submittedOrder['payment_method']); ?></span></div>
                <div class="receipt-item"><span class="receipt-label">Catatan</span><span class="receipt-value"><?php echo e($submittedOrder['notes'] ?: '-'); ?></span></div>
            </div>
            <?php if($whatsAppNumber): ?>
                <div class="receipt-actions">
                    <a class="wa-btn" href="https://wa.me/<?php echo e($whatsAppNumber); ?>?text=<?php echo e($whatsAppMessage); ?>" target="_blank" rel="noopener">
        ...
        <div class="section"><h3 class="section-title">Informasi Pelanggan</h3><div class="fields-grid">
            <div class="field full">
                ...
                <datalist id="customer-picker-list">
                    <?php $__currentLoopData = $customerOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customerOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($customerOption['name']); ?> - <?php echo e($customerOption['phone']); ?>"></option>
                        <option value="<?php echo e($customerOption['phone']); ?> - <?php echo e($customerOption['name']); ?>"></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </datalist>
            </div>
            <div class="field"><label>Nomor HP <span class="required">*</span></label><input class="input" id="customer-phone" type="text" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="081xxxxxxxxx"></div>
            <div class="field"><label>Nama Pelanggan <span class="required">*</span></label><input class="input" id="customer-name" type="text" name="customer_name" value="<?php echo e(old('customer_name')); ?>" placeholder="Masukkan nama pelanggan"></div>
            <div class="field full"><label>Alamat (Opsional)</label><input class="input" id="customer-address" type="text" name="address" value="<?php echo e(old('address')); ?>" placeholder="Masukkan alamat"></div>
        </div></div>
        <div class="section"><h3 class="section-title">Informasi Barang</h3><div class="fields-grid">
            <div class="field"><label>Warna</label><input class="input" type="text" name="color" value="<?php echo e(old('color')); ?>" placeholder="Contoh: Hitam, Putih, Merah"></div>
            <div class="field"><label>Kondisi</label><select class="select" name="condition"><option value="">-- Pilih Kondisi Barang --</option><option value="Masih cukup bersih" <?php if(old('condition') === 'Masih cukup bersih'): echo 'selected'; endif; ?>>Masih cukup bersih</option><option value="Kotor ringan" <?php if(old('condition') === 'Kotor ringan'): echo 'selected'; endif; ?>>Kotor ringan</option><option value="Kotor sedang" <?php if(old('condition') === 'Kotor sedang'): echo 'selected'; endif; ?>>Kotor sedang</option><option value="Kotor banget" <?php if(old('condition') === 'Kotor banget'): echo 'selected'; endif; ?>>Kotor banget</option><option value="Ada noda membandel" <?php if(old('condition') === 'Ada noda membandel'): echo 'selected'; endif; ?>>Ada noda membandel</option><option value="Perlu perawatan khusus" <?php if(old('condition') === 'Perlu perawatan khusus'): echo 'selected'; endif; ?>>Perlu perawatan khusus</option></select></div>
            <div class="field"><label>Barang <span class="required">*</span></label><select class="select" name="service_choice"><option value="">-- Pilih Barang --</option><option value="Sepatu" <?php if(old('service_choice') === 'Sepatu'): echo 'selected'; endif; ?>>Sepatu</option><option value="Topi" <?php if(old('service_choice') === 'Topi'): echo 'selected'; endif; ?>>Topi</option><option value="Tas" <?php if(old('service_choice') === 'Tas'): echo 'selected'; endif; ?>>Tas</option></select></div>
            <div class="field"><label>Merek</label><input class="input" type="text" name="brand" value="<?php echo e(old('brand')); ?>" placeholder="Contoh: Nike, Adidas, Converse"></div>
        </div></div>
        <div class="section"><h3 class="section-title">Layanan</h3><div class="fields-grid"><div class="field full"><select class="select" id="service-select" name="service"><option value="">-- Pilih Layanan --</option><?php $__currentLoopData = $serviceSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><optgroup label="<?php echo e($serviceSection['title']); ?>"><?php $__currentLoopData = $serviceSection['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($serviceItem['name']); ?>" data-price="<?php echo e($serviceItem['price_value'] ?? (int) preg_replace('/\D+/', '', $serviceItem['price'])); ?>" <?php if(old('service') === $serviceItem['name']): echo 'selected'; endif; ?>><?php echo e($serviceItem['name']); ?> - <?php echo e($serviceItem['price']); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></optgroup><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div></div></div>
        <div class="section"><h3 class="section-title">Foto Barang</h3><div class="fields-grid"><div class="field full"><div class="upload-panel"><div class="upload-actions"><button class="upload-btn primary" id="pick-photo-btn" type="button"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12"/><path d="M8 11l4 4 4-4"/><path d="M5 21h14"/></svg><span>Pilih dari Galeri</span></button><button class="upload-btn" id="open-camera-btn" type="button"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h4l2-2h4l2 2h4v12H4z"/><circle cx="12" cy="13" r="4"/></svg><span>Ambil Foto Sekarang</span></button></div><label class="upload-box" id="upload-box"><input class="upload-input" id="item-photo" name="item_photo" type="file" accept=".png,.jpg,.jpeg,image/png,image/jpeg" capture="environment"><div class="upload-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="M7 10l5-5 5 5"/><path d="M12 5v12"/></svg><strong>Ambil foto barang atau upload file</strong><span>PNG, JPG (max. 5MB)</span></div><div class="upload-preview" id="upload-preview"><img class="preview-thumb" id="preview-thumb" alt="Preview foto barang"><div class="preview-meta"><span class="preview-name" id="preview-name">Belum ada file</span><span class="preview-help">Admin dan pegawai bisa ambil ulang foto sebelum simpan order.</span></div></div></label><div class="camera-panel" id="camera-panel"><div class="camera-frame"><video class="camera-video" id="camera-video" autoplay playsinline muted></video><div class="camera-empty" id="camera-empty">Kamera belum aktif. Tekan "Nyalakan Kamera" atau gunakan galeri jika perangkat tidak mengizinkan akses kamera.</div></div><div class="camera-toolbar"><button class="upload-btn primary" id="start-camera-btn" type="button">Nyalakan Kamera</button><button class="upload-btn" id="capture-camera-btn" type="button" disabled>Ambil Jepretan</button><button class="upload-btn" id="close-camera-btn" type="button">Tutup Kamera</button></div><div class="camera-note">Di HP biasanya kamera belakang akan diprioritaskan. Di laptop, browser akan memakai webcam yang tersedia.</div></div><div class="upload-status" id="upload-status"></div><?php if(session('uploaded_photo_url')): ?><div class="preview-meta" style="margin-top:10px"><span class="preview-help">Foto terakhir tersimpan:</span><a href="<?php echo e(session('uploaded_photo_url')); ?>" target="_blank" rel="noopener" class="preview-name">Lihat file upload</a></div><?php endif; ?></div></div></div></div>
        <div class="section"><h3 class="section-title">Catatan</h3><div class="fields-grid"><div class="field full"><textarea class="textarea" name="notes" placeholder="Catatan tambahan (opsional)"><?php echo e(old('notes')); ?></textarea></div></div></div>
        <div class="section"><h3 class="section-title">Metode Pembayaran</h3><div class="fields-grid"><div class="field"><label>Pilih Metode Pembayaran <span class="required">*</span></label><select class="select" id="payment-method" name="payment_method"><option value="Cash (Tunai)" <?php if(old('payment_method') === 'Cash (Tunai)'): echo 'selected'; endif; ?>>Cash (Tunai)</option><option value="Transfer Bank" <?php if(old('payment_method') === 'Transfer Bank'): echo 'selected'; endif; ?>>Transfer Bank</option><option value="QRIS" <?php if(old('payment_method') === 'QRIS'): echo 'selected'; endif; ?>>QRIS</option></select></div><div class="field full" id="cash-payment-panel"><label>Total Layanan</label><input class="input" id="service-total-display" type="text" value="Rp 0" readonly><label style="margin-top:10px">Uang Dibayar <span class="required">*</span></label><input class="input" id="cash-paid-input" type="text" name="cash_paid" value="<?php echo e(old('cash_paid')); ?>" placeholder="Masukkan nominal tunai"><?php $__errorArgs = ['cash_paid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="preview-help" style="color:#b42318"><?php echo e($message); ?></span><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><div class="preview-meta" style="margin-top:8px"><span class="preview-help" id="cash-payment-summary">Masukkan nominal untuk melihat apakah pembayaran pas atau ada kembalian.</span></div></div><div class="field full"><div class="qris-panel" id="qris-payment-panel"><div class="qris-summary"><label>Total Pembayaran QRIS</label><div class="qris-total" id="qris-total-display">Rp 0</div><div class="qris-note">QRIS statis bisa langsung discan pelanggan. Nominal yang harus dibayar tetap mengikuti total layanan di bawah ini.</div></div><div class="qris-card"><?php if($qrisImageUrl): ?><img class="qris-image" src="<?php echo e($qrisImageUrl); ?>" alt="QRIS RaabShoes"><?php else: ?><div class="qris-placeholder">Taruh file QRIS asli di <strong>`public/images/qris-raabshoes.jpg`</strong><br>agar panel pembayaran bisa menampilkan gambar QRIS toko.</div><?php endif; ?><div class="preview-help">Nominal pembayaran yang diminta: <strong id="qris-total-caption">Rp 0</strong></div></div></div></div></div></div>
        <div class="actions"><a href="<?php echo e(route('orders.index')); ?>" class="btn btn-outline">Batal</a><button type="submit" class="btn btn-primary">Simpan Order</button></div>
    </form>
</section>
...
<script>
    (() => {
        ...
        const customerOptions = <?php echo json_encode($customerOptions, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/user/Downloads/raabshoes/manajement-raabshoes/resources/views/orders/create.blade.php ENDPATH**/ ?>