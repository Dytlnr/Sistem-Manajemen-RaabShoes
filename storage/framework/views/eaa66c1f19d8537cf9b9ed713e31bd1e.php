...
<div class="sections"><?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><section class="service-section"><h2 class="section-header"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 1 1.4 0l1.6 1.6a1 1 0 0 1 0 1.4l-8.9 8.9-4 1 1-4 8.9-8.9Z"/><path d="M13 8l3 3"/></svg><span><?php echo e($section['title']); ?></span></h2><div class="services-grid"><?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><article class="service-card" data-section="<?php echo e($section['title']); ?>" data-name="<?php echo e($item['name']); ?>" data-price="<?php echo e($item['price']); ?>" data-estimate="<?php echo e($item['estimate']); ?>"><div class="service-top"><div class="service-name"><?php echo e($item['name']); ?></div><span class="service-toggle"></span></div><div class="service-meta"><span>Harga</span><span class="service-value"><?php echo e($item['price']); ?></span><span>Estimasi</span><span class="service-estimate"><?php echo e($item['estimate']); ?></span></div><button type="button" class="edit-btn" data-edit-service><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 1 1.4 0l1.6 1.6a1 1 0 0 1 0 1.4l-8.9 8.9-4 1 1-4 8.9-8.9Z"/></svg><span>Edit</span></button></article><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div></section><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
<section id="edit-service" class="modal-overlay" aria-label="Edit Layanan"><a href="#" class="modal-backdrop" data-close-modal></a><div class="modal-card"><div class="modal-header"><h2 class="modal-title">Edit Layanan</h2></div><div class="modal-body"><form class="modal-form" id="edit-service-form"><div class="modal-field"><label class="modal-label">Kategori <span class="required">*</span></label><input class="modal-input" id="service-section-input" type="text"></div><div class="modal-field"><label class="modal-label">Nama Layanan <span class="required">*</span></label><input class="modal-input" id="service-name-input" type="text"></div><div class="modal-field"><label class="modal-label">Harga <span class="required">*</span></label><input class="modal-input" id="service-price-input" type="text"></div><div class="modal-field"><label class="modal-label">Estimasi <span class="required">*</span></label><input class="modal-input" id="service-estimate-input" type="text"></div><div class="modal-note">Perubahan ini langsung terlihat di halaman layanan saat ini. Kalau nanti mau disimpan permanen ke database, saya bisa sambungkan backend-nya juga.</div><div class="modal-actions"><a href="#" class="modal-btn cancel" data-close-modal>Batal</a><button type="submit" class="modal-btn save">Simpan Perubahan</button></div></form></div></div></section>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/user/Downloads/raabshoes/manajement-raabshoes/resources/views/services/index.blade.php ENDPATH**/ ?>