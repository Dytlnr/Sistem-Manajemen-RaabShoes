...
<section class="settings-card">
    <div class="tabs">
        <div class="tabs-left">
            <a href="{{ route('settings.index') }}" class="tab active"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M9 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm8 1a3 3 0 1 1 0-6 3 3 0 0 1 0 6ZM4 20a5 5 0 0 1 10 0H4Zm9.5 0a4.5 4.5 0 0 1 8.5 0h-8.5Z"/></svg><span>Manajemen Akun Pegawai</span></a>
        ...
        <div class="user-list">
            @foreach($users as $user)
                <article class="user-card">
                    ...
                    <span class="role-badge {{ ($user['role'] ?? 'pegawai') === 'admin' ? 'admin' : 'staff' }}">
                        {{ ($user['role'] ?? 'pegawai') === 'admin' ? 'Admin' : 'Pegawai' }}
                    </span>
                </article>
            @endforeach
        </div>
        ...
        <form method="post" action="{{ route('settings.users.store') }}" class="modal-form">
            ...
            <div class="field-grid">
                <div class="field">
                    ...
                    <input id="staff-name" name="name" type="text" value="{{ old('name') }}" placeholder="Contoh: Pegawai 2">
                </div>
                <div class="field">
                    <label for="staff-username">Username</label>
                    <input id="staff-username" name="username" type="text" value="{{ old('username') }}" placeholder="contoh: pegawai2">
                ...
                <div class="field">
                    ...
                    <input id="staff-phone" name="phone" type="text" value="{{ old('phone') }}" placeholder="08xxxxxxxxxx">
                </div>
                <div class="field">
