        ...
        <div class="admin-shell">
            <aside class="sidebar">
                ...
                <nav class="sidebar-nav" aria-label="Sidebar navigation">
                    <div class="nav-list">
                        <a href="{{ route('dashboard') }}" class="nav-item {{ $activeMenu === 'dashboard' ? 'active' : '' }}">
                            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3l9 7h-3v10h-5v-6H11v6H6V10H3l9-7Z"/></svg>
                            <span>Dashboard</span>
                        </a>
                        <a href="{{ route('orders.index') }}" class="nav-item {{ $activeMenu === 'orders' ? 'active' : '' }}">
                        ...
                        <a href="{{ route('customers.index') }}" class="nav-item {{ $activeMenu === 'customers' ? 'active' : '' }}">
                        ...
                        <a href="{{ route('services.index') }}" class="nav-item {{ $activeMenu === 'services' ? 'active' : '' }}">
                        ...
                        <a href="{{ route('reports.index') }}" class="nav-item {{ $activeMenu === 'reports' ? 'active' : '' }}">
                        ...
                        <a href="{{ route('transaction-history.index') }}" class="nav-item {{ $activeMenu === 'transaction-history' ? 'active' : '' }}">
                        ...
                        <a href="{{ route('settings.index') }}" class="nav-item {{ $activeMenu === 'settings' ? 'active' : '' }}">
                        ...
                        <div class="admin-menu">
                            ...
                            <div class="admin-menu-panel" id="admin-menu-panel" role="menu" aria-label="Menu admin">
                                <div class="admin-menu-info">
                                    <span class="admin-menu-name">{{ $accountLabel }}</span>
