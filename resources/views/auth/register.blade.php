...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sign Up | Raab Shoes</title>
        ...
        <div class="auth-layout">
            ...
            <div class="card-wrap">
                <main class="register-card">
                    ...
                    <div class="card-top">
                        <div>
                            <p class="welcome">Welcome to Raab Shoes</p>
                            <h1 class="title">Akun Dibuat Admin</h1>
                        </div>
                    ...
                    <form class="form-block" action="{{ route('register.store') }}" method="post">
                        @csrf
                        <div class="field is-primary">
                            <label>Informasi</label>
                            <div class="input-shell" style="height:auto;padding:18px 20px;align-items:flex-start">
                                <div style="font-size:.96rem;line-height:1.7">
                                    Akun pegawai tidak bisa dibuat dari halaman ini.<br>
                                    Hanya admin yang dapat menambahkan akun dari menu <strong>Pengaturan Sistem</strong>.<br><br>
                                    Kalau Anda sudah diberi akun oleh admin, silakan langsung masuk lewat halaman login.
                                </div>
                            </div>
                        </div>

                        <button class="submit-btn" type="submit">Minta Daftar</button>
                    </form>
                </main>
            </div>
        </div>
