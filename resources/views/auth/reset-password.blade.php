            ...
            <section class="card">
                ...
                <form action="{{ route('password.update') }}" method="post">
                    ...
                    <div class="field">
                        ...
                        <input id="password" name="password" type="password" placeholder="Minimal 8 karakter" autofocus>
                    </div>
                    ...
                    <button type="submit" class="submit">Simpan Password Baru</button>
                </form>
            </section>
        </main>
    </body>
